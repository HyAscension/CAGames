...
namespace CanadaGames.Data
{
    public class CanadaGamesContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Contingent>().HasIndex(p => p.Code).IsUnique();
            modelBuilder.Entity<Gender>().HasIndex(p => p.Code).IsUnique();
            modelBuilder.Entity<Sport>().HasIndex(p => p.Code).IsUnique();
