...
namespace CanadaGames.Controllers
{
    ...
    public class CoachesController : Controller
    {
        ...
        // GET: Coaches
        public async Task<IActionResult> Index(string SearchString, int? page, int? pageSizeID, string actionButton, string sortDirection = "asc", string sortField = "Last Name")
        {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if (await TryUpdateModelAsync<Coach>(coachToUpdate, "", d => d.FirstName, d => d.MiddleName, d => d.LastName))
            {
                try
                {
                    await _context.SaveChangesAsync();
