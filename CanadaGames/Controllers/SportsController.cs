...
namespace CanadaGames.Controllers
{
    public class SportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Code,Name")] Sport sport, string[] selectedOptions)
        {
            ...
            {
                if (dex.GetBaseException().Message.Contains("UNIQUE constraint failed: Sports.Code"))
                {
                    ModelState.AddModelError("Code", "Unable to save changes. Remember, you cannot duplicate Sport codes.");
                }
                else
                {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            catch (DbUpdateException dex)
            {
                ...
                {
                    ModelState.AddModelError("", "Unable to Delete Sport. Remember, you cannot delete a Sport with Athletes or Athlete codes.");
                }
                else
                {
                    ModelState.AddModelError("", "Unable to save changes. Try again, and if the problem persists see your system administrator.");
